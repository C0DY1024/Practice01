                ...
                <div class="col-xs-12">
                    ...
                    <form id="work">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="pre_img"><img class="preview_img" id="preview_img" src="../files/images/圖片預覽.png" /></div>
                            <div class="pre_vid" ><video class="preview_video" id="preview_video"src="" controls> </div>
                        </div>
            ...
            if($("#intro").val()==''){
                ...
                alert('請確認檔案類型');
                    ...
                    if(file_type == "video/mp4"){
                        ...
                        $("#video_path").val(save_path);
                        $("#image_path").val("");
                        file_data.append("image_path", $("#image_path").val());
                        file_data.append("video_path", $("#video_path").val());
                        
                    }else{
                        save_path="files/images/"+upload_file.files[0]['name'];
                        $("#video_path").val("");
                        $("#image_path").val(save_path);
                        file_data.append("image_path", $("#image_path").val());
                        file_data.append("video_path", $("#video_path").val());
